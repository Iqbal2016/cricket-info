                        ...
                        <ul class="row">
                            ...
                            <li class="col-md-12">
                                <div class="kode-time-zoon">
                                    ...
                                    <h5><a href="#"><?php echo $blog_details->blog_title; ?></a></h5>
                                </div>
                                <div class="kode-blog-info">
                                    <ul class="kode-blog-options">
                                        <li><a href="#"><i class="fa fa-user"></i> <?php echo $blog_details->author_name; ?></a></li>
                                ...
                                <figure><a href="#"><img src="<?php echo $blog_details->blog_images; ?>" alt="" height="300"></a></figure>
                                 <p><?php echo $blog_details->blog_description; ?></p>
                                 <p>
                                 <!------------------------------start commence------------------------------->
                                    <?php
                                    foreach ($comments_by_blog_id as $comments) {
                                        ?>
                                        <p><strong><?php echo $comments->blogger_name ?> :</strong>
                                            <?php echo $comments->comments ?></p>
                                    <?php } ?>
                                    <?php if ($blogger_id) { ?>
                                    ...
                                    <?php } else { ?>
                                        Please <a href="<?php echo base_url(); ?>viewer_login.html"><b>Login</b></a> to post your comment.
                                    <?php } ?>
                                    <!---------------------------------end commence------------------------------------------->
                                   </p>
                            </li>                
