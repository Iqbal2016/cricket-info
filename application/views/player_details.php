          ...
          <div class="container">
            <div class="row">
                ...
                <div class="kode-pagecontent col-md-9">
                  ...
                  <div class="row">
                      <div class="col-md-5"><a href="#" class="kode-player-thumb"><img src="<?php echo $player_detail->player_Image; ?>" alt="" width="350" height="425"></a></div>
                    <div class="col-md-7">
                      
                      <div class="kode-detail-element">
                        <h2><?php echo $player_detail->player_Name; ?></h2>
                        ...
                        <p><?php echo $player_detail->player_Description; ?></p>
                      ...
                      <table class="kode-table">
                        ...
                        <tbody>
                          <tr>
                           ...
                           <tr>
                            <td>Location:</td>
                            <td><?php echo $player_detail->player_Country; ?></td>
                          </tr>
                          <tr>
                            <td>Squad Number:</td>
                            <td>45</td>
                  ...
                  <div class="kode-gallery">
                    <ul class="row">
                      <li class="col-md-6">
                          <figure><a href="#"><img src="<?php echo base_url(); ?>extra-images/gallery-list-1.jpg" alt=""></a>
