<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">New Biography</h1>
    </div>
</div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form action="<?php echo base_url(); ?>biography_admin/save_biography" method="post" enctype="multipart/form-data">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Palyer Name</label> <input id="player_Name"
                                                                     class="form-control" placeholder="Player Name" name="player_Name" required="required">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" id="player_Description" name="player_Description"></textarea>
                                </div>
								<div class="form-group">
                                    <label>Palyer Weight</label> <input id="player_Weight"
                                                                     class="form-control" placeholder="Player Weight" name="player_Weight" required="required">
                                </div>
                            ...
                            <div class="col-lg-6">
								<div class="form-group">
                                    <label>Palyer Height</label> <input id="player_Height"
                                                                     class="form-control" placeholder="Player Height" name="player_Height" required="required">
                                </div>
                                <div class="form-group">
                                    <label>Palyer Age</label> <input id="player_Age"
                                                                      class="form-control" placeholder="Author Age"  name="player_Age" required="required">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Palyer Position</label> <input id="player_Position"
                                                                      class="form-control" placeholder="Player Position"  name="player_Position" required="required">
                                </div>
                                <div class="form-group">
