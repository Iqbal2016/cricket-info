                            ...
                            foreach ($all_blog as $v_blog) {
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url(); ?>super_admin/delete_blog/<?php echo $v_blog->blog_id ?>" onclick="return confirm('Are you sure want to delete');"><input type="image" src="<?php echo base_url() ?>images/icn_trash.png" title="Delete"></a>
