...
//        exit();
    ...
    public function index() {
        $data = array();
        $data['adminmaincontent'] = $this->load->view('admin/admin_home_content', $data, TRUE);
    ...
    public function all_blog() {
		...
		/*------------------Start pagination-----------------------------*/
        $this->load->library('pagination');
        $config['base_url'] = base_url() .'super_admin/all_blog/';
        ...
        $data['all_blog'] = $this->sa_model->select_all_blog_info($config['per_page'], $this->uri->segment(3));              
